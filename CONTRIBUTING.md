...
[issue](https://github.com/zalando/zalenium/issues) reporting the same problem does not already exist. If there is an 
...
## Suggest a Feature
To request a new feature, open an [issue](https://github.com/zalando/zalenium/issues/new) and summarize the desired 
functionality and its use case. Set the issue label to "feature".

## Contribute code
This is a rough outline of what the workflow for code contributions looks like:
- Check the list of open [issues](https://github.com/zalando/zalenium/issues). Either assign an existing issue to 
