...
<details>
    ...
    export SAUCE_LABS_URL=<your Sauce Labs url> #default value is "http://ondemand.saucelabs.com:80"
    docker run --rm -ti --name zalenium -p 4444:4444 \
...
<details>
    ...
    export BROWSER_STACK_URL=<your BrowserStack url> #default value is "http://hub-cloud.browserstack.com:80"
    docker run --rm -ti --name zalenium -p 4444:4444 \
...
<details>
    ...
    export TESTINGBOT_URL=<your TestingBot url> # default value is "http://hub.testingbot.com:80"
    docker run --rm -ti --name zalenium -p 4444:4444 \
